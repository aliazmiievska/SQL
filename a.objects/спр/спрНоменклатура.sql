...
---
,спрЗначенияСвойствОбъектов AS ( -- ../спр/спрЗначенияСвойствОбъектов.sql
    SELECT
...
---
,спрВидиНоменклатури AS ( -- ../спр/спрВидиНоменклатури.sql
    SELECT
...
---
,спрПроекти AS ( -- ../спр/спрПроекти.sql
    SELECT
    ...
    WHERE 
        спрПроекти._Marked = 0 -- ПоміткаВидалення
)
---
...
,Props_Svoistva_Viz_Номенклатура AS ( -- ../props/Props_Svoistva_Viz_Номенклатура.sql
    SELECT
...
-- SELECT *
-- FROM Props_ВільнийЗалишок_спрНоменклатура
-- ORDER BY Join_Agregat_SumByEachNomenklatura_ВнутренниеРезервы.НазваНоменклатури

SELECT * FROM Props_ВільнийЗалишок_спрНоменклатура
-- ORDER BY Дата_док_ЗаказПокупателя DESC
-- WHERE SumByEachNomenklatura_ВнутренниеРезервы <> 0
-- ORDER BY НазваНоменклатури