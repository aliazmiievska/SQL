...
,спрВидыПараметровПроизводства AS (
    SELECT
        ...
        спрВидыПараметровПроизводства._Folder AS imp__Группа__спрНоменклатура_ВидиПарамПроізводства
...
,спрВидыПараметровВыпускаПродукции AS (
    SELECT
        ...
        спрВидыПараметровВыпускаПродукции._Folder AS imp__Группа__спрНоменклатура_ВидиПарамВипускПрод
...
SELECT
        ...
        ,спрНоменклатура_Комплектуючі.own__Наименование__спрНоменклатура                AS НоменклатураКомплектуючої
